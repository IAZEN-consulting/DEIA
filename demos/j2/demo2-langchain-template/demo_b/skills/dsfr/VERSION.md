...
Copie de [numerique-gouv/dsfr-skill](https://github.com/numerique-gouv/dsfr-skill)
(Licence Ouverte 2.0 / Etalab), recuperee le 2026-09-07 pour la demo j2.

Seul changement : les dossiers `composants/*/assets/` ont ete retires. Ils ne
contenaient que des captures PNG (1,9 Mo), qu'aucun outil de l'agent ne sait
lire. Les fichiers `.md` et `examples/*.html` sont inchanges.
